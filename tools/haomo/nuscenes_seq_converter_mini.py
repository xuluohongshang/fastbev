...
def add_adj_info():
    ...
    for set in ['test', 'val', 'train', ]:
        # if set in ['val', 'train']:
        #     continue
        dataset = pickle.load(open('./data/nuscenes_v1.0-mini_pkl/nuscenes_infos_%s.pkl' % set, 'rb'))
        # if set in ['train', 'val']:
        ...
        filename = './data/nuscenes_v1.0-mini_pkl/nuscenes_infos_%s_4d_interval%d_max%d.pkl' % (set, interval, max_adj)
